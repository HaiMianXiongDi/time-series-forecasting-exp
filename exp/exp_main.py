...
from models import Informer, Autoformer, Transformer, DLinear, Linear, NLinear, PatchTST, Time_Unet, LPUNET
            ...
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(vali_loader):
                ...
                if self.args.use_amp:
                    with torch.cuda.amp.autocast():
                        if 'Linear' in self.args.model or 'TST' in self.args.model or 'Unet' in self.args.model or 'LPUNET' in self.args.model:
    ...
    def train(self, setting):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(train_loader):
                ...
                # 输出当前进度和总的 iters 数量
                if (i + 1) % 100 == 0:  # 每5次迭代输出一次进度
                    print(f"\titers: {i + 1}/{total_iters}, epoch: {epoch + 1} | loss: {loss.item():.7f}")
