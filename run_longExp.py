...
if __name__ == '__main__':
    ...
    #LPUNET
    parser.add_argument('--avgpool_n', type=int, default=1, help='avg_num')   
    # --interp_ratio  单个 float，默认 1.0
    parser.add_argument(
        '--interp_ratios',
        type=float,
        default=1.0,
        help='interpolation ratio (>=1.0) applied to the whole sequence, \
    e.g. --interp_ratio 1.5'
    )

  
    
    
    parser.add_argument('--stage_num', type=int, default=5, help='stage num')   
    parser.add_argument('--stage_pool_kernel', type=int, default=3, help='AvgPool1d kernel_size') #3
    parser.add_argument('--stage_pool_stride', type=int, default=2, help='AvgPool1d stride') #2
    ...
    # 新增的频域降采样top-k参数-------------------------------------------------------------
    parser.add_argument('--freq_downsampling_percentage', type=float, default=0.5, help='Percentage of top frequencies to keep during frequency domain downsampling')
    
    #=======
    parser.add_argument('--patch_len', type=int, default=16, help='patch length') #------------------------------------------4
    ...
    #corr
    parser.add_argument('--corr_lower_limit', type=float, default=0.55, help='find corr ')
    ...
    # 实验相关参数
    parser.add_argument('--exp1', type=int, default=1, help='experiment parameter 1')
